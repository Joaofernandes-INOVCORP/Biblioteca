            ...
            <div class="my-3">
                <form action="" method="get" class="flex flex-wrap gap-3">
                    ...
                    <label class="floating-label">
                        <input type="number" min="0" step="0.01" placeholder="Preço desde" class="input input-md bg-orange-100 border border-base-100" name="price_min" />
                        <span class="text-white">Preço desde</span>
                    </label>


                    <label class="floating-label">
                        <input type="number" min="0" step="0.01" placeholder="Preço até" class="input input-md bg-orange-100 border border-base-100" name="price_max" />
